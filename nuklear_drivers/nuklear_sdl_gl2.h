...
nk_sdl_handle_event(SDL_Event *evt)
{
    ...
    if (evt->type == SDL_KEYUP || evt->type == SDL_KEYDOWN) {
        ...
        if (sym == SDLK_RSHIFT || sym == SDLK_LSHIFT)
        	...
        	nk_input_key(ctx, NK_KEY_RUN, down && (state[SDL_SCANCODE_LCTRL] || state[SDL_SCANCODE_RCTRL]));
        else if (sym == SDLK_o)
            ...
            nk_input_key(ctx, NK_KEY_PASTE, down && (state[SDL_SCANCODE_LCTRL] || state[SDL_SCANCODE_RCTRL]));
        else if (sym == SDLK_x)
            nk_input_key(ctx, NK_KEY_CUT, down && (state[SDL_SCANCODE_LCTRL] || state[SDL_SCANCODE_RCTRL]));
        else if (sym == SDLK_b)
            nk_input_key(ctx, NK_KEY_TEXT_LINE_START, down && (state[SDL_SCANCODE_LCTRL] || state[SDL_SCANCODE_RCTRL]));
        else if (sym == SDLK_e)
            nk_input_key(ctx, NK_KEY_TEXT_LINE_END, down && (state[SDL_SCANCODE_LCTRL] || state[SDL_SCANCODE_RCTRL]));
        else if (sym == SDLK_UP) {
        	if ((state[SDL_SCANCODE_LCTRL] || state[SDL_SCANCODE_RCTRL]))
        		nk_input_key(ctx, NK_KEY_CTRL_UP, down);
        	else nk_input_key(ctx, NK_KEY_UP, down);
        }
        else if (sym == SDLK_DOWN) {
        	if ((state[SDL_SCANCODE_LCTRL] || state[SDL_SCANCODE_RCTRL]))
        		nk_input_key(ctx, NK_KEY_CTRL_DOWN, down);
        	else nk_input_key(ctx, NK_KEY_DOWN, down);
        }
